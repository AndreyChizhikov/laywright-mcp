...
test('has title smoke',{ tag: '@smoke' }, async ({ page }) => {
  await page.goto('/');
...
test('get started link smoke',{ tag: '@smoke' }, async ({ page }) => {
  await page.goto('/');
...
test('header navigation links smoke',{ tag: '@smoke' }, async ({ page }) => {
...
test('footer links - positive scenarios smoke',{ tag: '@smoke' }, async ({ page }) => {
  const welcomePage = new WelcomePage(page);
  await welcomePage.navigate();
...
test('footer links - negative scenarios smoke',{ tag: '@smoke' }, async ({ page }) => {
  const welcomePage = new WelcomePage(page);
  await welcomePage.navigate();
...
test('search component - valid search smoke',{ tag: '@smoke' }, async ({ page }) => {
  const welcomePage = new WelcomePage(page);
  await welcomePage.navigate();
...
test('search component - invalid search smoke',{ tag: '@smoke' }, async ({ page }) => {
  const welcomePage = new WelcomePage(page);
  await welcomePage.navigate();
